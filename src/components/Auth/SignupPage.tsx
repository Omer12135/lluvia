...
import { Mail, Lock, User, Eye, EyeOff, Loader2, ArrowLeft, Workflow } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 text-gray-400 hover:text-white transition-colors mb-6">
          ...
          <p className="text-gray-400">Start automating your workflows with LLUVIA AI</p>
        </div>
